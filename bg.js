        ...
        chrome.storage.sync.get('block', function(res){
          ...
          chrome.browserAction.onClicked.addListener(function(tab) {
            chrome.browserAction.getBadgeText({}, function(result) {
              if(result == 'On'){ chrome.browserAction.setBadgeText({text:'Stats'}); chrome.browserAction.setPopup({ popup: 'popup.html' })
              }else if(result == 'Stats'){
                chrome.storage.sync.set({'block': false}, function() { console.log('Turn Off'); chrome.browserAction.setPopup({popup: ''}) });
              }else if(result == 'Off'){
                chrome.storage.sync.set({'block': true}, function() { console.log('Turn On'); chrome.browserAction.setPopup({popup: ''}) });
